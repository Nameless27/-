Shader "PlantsVsZombies/PoolBaseShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                float2 uvoffset;
                uvoffset.x = sin(phase2.y + wavetime2) * 0.002 + sin(phase2.y + wavetime1) * 0.005;
                uvoffset.y = sin(phase2.x + wavetime5) * 0.01 + sin(phase2.x + wavetime3) * 0.015 + sin(phase2.x + wavetime4) * 0.005;
